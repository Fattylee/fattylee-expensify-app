/*! eruda-code v1.0.0 https://github.com/liriliri/eruda-code#readme */
...
var _codemirror = __webpack_require__(47);
...
module.exports = function (eruda) {
    var _eruda$util = eruda.util,
        ...
        _beautify = _eruda$util.beautify;

    var Code = function (_eruda$Tool) {
        (0, _inherits3.default)(Code, _eruda$Tool);

        function Code() {
            (0, _classCallCheck3.default)(this, Code);

            var _this = (0, _possibleConstructorReturn3.default)(this, (Code.__proto__ || (0, _getPrototypeOf2.default)(Code)).call(this));

            _this.name = 'code';
            _this._style = evalCss(__webpack_require__(106));
            _this._CodeMirrorStyle = evalCss(__webpack_require__(107));
            _this._CodeMirrorCustomStyle = evalCss(__webpack_require__(108));
            _this._editor = null;
            return _this;
        }
        ...
        (0, _createClass3.default)(Code, [{
            ...
            value: function init($el, container) {
                (0, _get3.default)(Code.prototype.__proto__ || (0, _getPrototypeOf2.default)(Code.prototype), 'init', this).call(this, $el, container);

                $el.html(__webpack_require__(109)());
                this._bindEvent();
            }
        }, {
            key: 'show',
            value: function show() {
                ...
                (0, _get3.default)(Code.prototype.__proto__ || (0, _getPrototypeOf2.default)(Code.prototype), 'show', this).call(this);
                if (!this._editor) {
                    var container = this._$el.find('.eruda-editor').get(0);
                    this._editor = _codemirror2.default.fromTextArea(container, {
                        lineNumbers: 'true',
                        mode: 'javascript'
                    });
                    (0, _util.nextTick)(function () {
                        return _this2._editor.refresh();
                    });
                }
            }
        }, {
            key: 'hide',
            value: function hide() {
                (0, _get3.default)(Code.prototype.__proto__ || (0, _getPrototypeOf2.default)(Code.prototype), 'hide', this).call(this);
            }
        }, {
            key: 'run',
            value: function run() {
            ...
            value: function beautify() {
                ...
                editor.setValue(_beautify(value));
            }
        }, {
            key: 'copy',
            value: function copy() {
                (0, _util.copy)(this._editor.getValue());
            }
        }, {
            key: 'clear',
            ...
            value: function destroy() {
                (0, _get3.default)(Code.prototype.__proto__ || (0, _getPrototypeOf2.default)(Code.prototype), 'destroy', this).call(this);
    ...
    var evalJs = function evalJs(code) {
        var ret = void 0;
...
module.exports = {
  set: Object.setPrototypeOf || ('__proto__' in {} ? // eslint-disable-line
    function (test, buggy, set) {
      try {
        set = __webpack_require__(22)(Function.call, __webpack_require__(36).f(Object.prototype, '__proto__').set, 2);
        set(test, []);
...
"use strict";
/* WEBPACK VAR INJECTION */(function(process) {// Built by eustia.


Object.defineProperty(exports, "__esModule", {
    value: true
});
exports.nextTick = exports.copy = exports.extend = exports.createAssigner = exports.each = exports.isArrLike = exports.isNum = exports.isFn = exports.objToStr = exports.keys = exports.has = exports.optimizeCb = exports.isUndef = exports.noop = exports.allKeys = undefined;

var _setImmediate2 = __webpack_require__(98);
...
var copy = exports.copy = _.copy = function () {
...
// module
exports.push([module.i, ".eruda-dev-tools .eruda-tools .eruda-code {\n  padding-bottom: 40px; }\n  .eruda-dev-tools .eruda-tools .eruda-code .eruda-editor {\n    height: 100%; }\n  .eruda-dev-tools .eruda-tools .eruda-code .eruda-bottom-bar {\n    height: 40px;\n    background: #fff;\n    position: absolute;\n    left: 0;\n    bottom: 0;\n    width: 100%;\n    font-size: 0;\n    border-top: 1px solid #eceffe; }\n    .eruda-dev-tools .eruda-tools .eruda-code .eruda-bottom-bar .eruda-btn {\n      cursor: pointer;\n      text-align: center;\n      color: #707d8b;\n      font-size: 14px;\n      line-height: 40px;\n      width: 25%;\n      border-right: 1px solid #eceffe;\n      display: inline-block;\n      -webkit-transition: background 0.3s, color 0.3s;\n      transition: background 0.3s, color 0.3s; }\n      .eruda-dev-tools .eruda-tools .eruda-code .eruda-bottom-bar .eruda-btn:active {\n        background: #2196f3;\n        color: #fff; }\n      .eruda-dev-tools .eruda-tools .eruda-code .eruda-bottom-bar .eruda-btn.eruda-active {\n        color: #2196f3; }\n", ""]);
...
// module
exports.push([module.i, ".eruda-dev-tools .eruda-tools .CodeMirror {\r\n    height: 100%;\r\n}\r\n\r\n/* Sync style with chrome dev-tool */\r\n.eruda-dev-tools .eruda-tools .cm-keyword {color: hsl(310, 86%, 36%);}\r\n.eruda-dev-tools .eruda-tools .cm-number {color: hsl(248, 100%, 41%);}\r\n.eruda-dev-tools .eruda-tools .cm-comment {color: hsl(120, 100%, 23%) !important; font-style: italic;}\r\n.eruda-dev-tools .eruda-tools .cm-string {color: hsl(1, 80%, 43%) !important;}\r\n.eruda-dev-tools .eruda-tools .cm-string-2 {color: hsl(1, 99%, 39%) !important;}\r\n.eruda-dev-tools .eruda-tools .cm-atom {color: hsl(310, 86%, 36%);}\r\n.eruda-dev-tools .eruda-tools .cm-def {color: hsl(240, 73%, 38%);}\r\n.eruda-dev-tools .eruda-tools .cm-operator {color: hsl(27, 100%, 30%);}\r\n.eruda-dev-tools .eruda-tools .cm-meta {color: hsl(27, 100%, 30%);}\r\n.eruda-dev-tools .eruda-tools .cm-variable-2 {color: hsl(240, 73%, 38%);}", ""]);
